...
Source files: /var/folders/4d/vcs_9pns27q909vg49074y3c0000gp/T/eds-extract-f15d544a-bd39-4a1c-b04c-bab1f82a50ff/my-react-app/src/components/ProductListing/ProductListing.js
...
- `GET` "https://dummyjson.com/products?limit=10&skip=10": author-time; The dependency uses a standard `fetch` call triggered at mount time (`mount`). Since the URL is public and does not require authentication headers or tokens, it can be fetched statically during the build process (or pre-rendered) without needing user credentials.
