...
Source files: /var/folders/4d/vcs_9pns27q909vg49074y3c0000gp/T/eds-extract-45e59fb6-4315-45cc-be76-a3ffd34983cc/my-react-app/src/components/ProductListing/ProductListing.js
...
- `GET` "https://dummyjson.com/products?limit=10&skip=10": author-time; The dependency uses a standard 'fetch' operation triggered at mount time. Since the URL ('https://dummyjson.com/products?limit=10&skip=10') is public and does not require authentication headers or tokens, it can be fetched statically during the build process (or pre-rendered) without needing user interaction or runtime decoration.
